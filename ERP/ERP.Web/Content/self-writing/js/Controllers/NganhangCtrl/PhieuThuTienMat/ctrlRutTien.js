...
app.controller('ctrlRutTien', ctrlRutTien);
ctrlRutTien.$inject = ['$rootScope', '$scope', "$location", '$http', '$uibModal'];
function ctrlRutTien($rootScope, $scope, $location, $http, $uibModal) {
    ...
    $scope.onSave = function () {
        ...
        $http({
            ...
            data: {
                ...
                LY_DO_NOP: 'Rút tiền gửi về nộp quỹ',
