...
app.controller('ctrlTamUng', ctrlTamUng);
ctrlTamUng.$inject = ['$rootScope', '$scope', "$location", '$http', '$uibModal'];
function ctrlTamUng($rootScope, $scope, $location, $http, $uibModal) {
