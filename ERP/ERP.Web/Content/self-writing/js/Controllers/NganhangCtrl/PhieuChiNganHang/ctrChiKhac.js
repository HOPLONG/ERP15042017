...
app.controller('ctrChiKhac', ctrChiKhac);
ctrChiKhac.$inject = ['$rootScope', '$scope', "$location", '$http', '$uibModal'];
function ctrChiKhac($rootScope, $scope, $location, $http, $uibModal) {
    $scope.title = 'ctrChiKhac';
    ...
    $http.get(window.location.origin + '/api/Api_NhaCungCap')
           .then(function (response) {
               if (response.data) {
    ...
    //
        ...
        $scope.addHachToan = function() {
            ...
            $scope.listThue.push({
                ...
                TIEN_THUE_GTGT: null,
                CK_THUE_GTGT: null,
                GIA_TRI_HHDV_CHUA_THUE: null,
                NGAY_HD: null,
                SO_HD: null,
                MAU_SO_HD: null,
                KY_HIEU_HD: null,
                MA_NHA_CUNG_CAP: $scope.info.ma_doi_tuong
            });
        ...
        $scope.save = function () {
            ...
            $http({
                ...
                data: {
                    ...
                    NGAY_CHUNG_TU: $scope.info.ngay_chung_tu.format('DD/MM/YYYY'),
                    NGAY_HACH_TOAN: $scope.info.ngay_hach_toan.format('DD/MM/YYYY'),
                    TAI_KHOAN_CHI: $scope.info.so_tai_khoan,
                    MA_DOI_TUONG: $scope.info.ma_doi_tuong,
                    NOI_DUNG_THANH_TOAN: 'Trả Các Khoản vay',
