...
app.controller('ctrTraCacKhoanVay', ctrTraCacKhoanVay);
ctrTraCacKhoanVay.$inject = ['$rootScope', '$scope', "$location", '$http', '$uibModal'];
function ctrTraCacKhoanVay($rootScope, $scope, $location, $http, $uibModal) {
    $scope.title = 'ctrTraCacKhoanVay';
    ...
    $scope.noi_dung_thanh_toan = 'TraCacKhoanVay';
    function initValue() {
