...
namespace ERP.Web.Models.Database
{
    ...
    public partial class ERP_DATABASEEntities : DbContext
    {
        ...
        public virtual ObjectResult<HopLong_PhanTrangKhachHang_Result> HopLong_PhanTrangKhachHang(Nullable<int> sotrang, string sale)
        {
            var sotrangParameter = sotrang.HasValue ?
                new ObjectParameter("sotrang", sotrang) :
                new ObjectParameter("sotrang", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<HopLong_PhanTrangKhachHang_Result>("HopLong_PhanTrangKhachHang", sotrangParameter, saleParameter);
        }
